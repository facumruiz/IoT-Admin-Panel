...
const IoTDeviceTable: React.FC<IoTDeviceTableProps> = ({ devices }) => {
    ...
    >
              ...
              >
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="text-sm text-white">
                    ...
                    {device.unit && (
                      <span className="text-gray-300 ml-1">{device.unit}</span>
                    )}
                  </div>
                </td>
      ...
      {devices.length === 0 && (
        <div className="text-center py-12">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-300">No devices</h3>
