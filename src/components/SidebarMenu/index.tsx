...
const SidebarMenu: React.FC = () => {
  ...
  const [activeItem, setActiveItem] = useState("last-messages");
  ...
  return (
    <div className="flex h-screen w-screen">
      ...
      <div className="flex-1 p-8" style={{ backgroundColor: "#0F160A" }}>
        <div className="text-white">
          <h1 className="text-2xl font-bold mb-4">IoT Dashboard</h1>
          <div
            className="p-6 rounded-lg"
            style={{ backgroundColor: "#27391C", border: "1px solid #2DD843" }}
          >
            <h2
